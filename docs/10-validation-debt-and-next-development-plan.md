...
| RAG K6 | 未实现桌面 Knowledge/Assistant 可视化 |
...
1. 验证 LiteLLM 下的 OpenAI/Claude 兼容配置，不分别重写 Provider；
...
下一项开发工作固定为 **D4：桌面 Knowledge/Assistant**。D1-D3 的真实 Provider 和导入诊断烟雾测试登记在 V3，不阻塞进入 K6。
